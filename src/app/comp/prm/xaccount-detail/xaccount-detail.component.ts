...
@Component({
  selector: 'app-xaccount-detail',
  templateUrl: './xaccount-detail.component.html',
  styleUrls: ['./xaccount-detail.component.css']
})
export class XAccountDetailComponent implements OnInit {
